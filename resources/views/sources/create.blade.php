...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Create Source</h1>
    </div>

    <div class="bg-white shadow sm:rounded-lg p-6" x-data="{ connector: '' }">
        <form action="{{ route(config('extract-data.route_name_prefix', 'andach-leat.') . 'sources.store') }}" method="POST">
            @csrf
